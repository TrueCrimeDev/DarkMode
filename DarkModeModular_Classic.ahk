/*
DarkModeModular_Classic.ahk — classic dark mode GUI framework for AutoHotkey v2 (alpha.17-.28)

Renamed 2026-09-13 from DarkModeModular.ahk. Lib/DarkModeModular.ahk is now the
alpha.30 main build; this NumGet-era copy stays only for standalone scripts that
still call the classic-only surface (DarkTooltip.Show, _DarkButton.SetText).
Never include it together with DarkModeModular.ahk or _Alpha (same class names).

Usage:
  #Include DarkModeModular_Classic.ahk
