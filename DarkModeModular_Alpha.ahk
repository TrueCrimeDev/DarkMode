/*
DarkModeModular_Alpha.ahk — Dark mode GUI framework for AutoHotkey v2 (alpha.30, EXPERIMENTAL)

The sandbox copy of the framework. Role swap 2026-09-13: Lib/DarkModeModular.ahk
is the MAIN, polished build and the file scripts include; new features land HERE
first. Promotion to the main build: point Tests/DarkMode_Lib.ahk at this file,
get Tests/DarkMode_Registry_Test.ahk, DarkModeFable_Merge_Test.ahk and
DarkMode_Leak_Test.ahk to ALL PASS headless plus a clean /validate, then copy
this file over DarkModeModular.ahk and restore that file's header. Queue and
log: Lib/DarkModeModular_Alpha.roadmap.md. At the swap the two files were
identical below the header. Never include this file together with
DarkModeModular.ahk or DarkModeModular_Classic.ahk (same class names).
